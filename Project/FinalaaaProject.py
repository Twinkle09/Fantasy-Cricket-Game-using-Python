...
##########################################################################################
    ...
    def file_save(self):
        ...
        for i in range(len(List)):
            curser.execute("INSERT INTO qq ('NAMES','PLAYERS','SCORES') VALUES ('%s','%s','%d')"%(teamname,List[i][0],List[i][1]))
    ...
    def combo2(self):
        ...
        myteam = self.eval_screen.SelectTeam.currentText()
        cu.execute("SELECT PlAYERS from qq WHERE NAMES='"+team+"';")
        player= cu.fetchall()
        ...
        cu.execute("SELECT SCORES from qq WHERE NAMES='"+team+"';")
        score=cu.fetchall()
        self.teamscore=[]
    ...
    def boxclose(self):
        ...
        myteam= sqlite3.connect('india.db')
        curser= myteam.cursor()
        curser.execute("SELECT PLAYERS from qq WHERE NAMES= '"+teamname+"';")
        hu= curser.fetchall()
